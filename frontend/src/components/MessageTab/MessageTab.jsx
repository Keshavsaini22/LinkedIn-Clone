...
export default function MessageTab({ connectedUser, setConnectedUser,room,setRoom }) {
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <CustomTabPanel value={value} index={0} >
                <Box onClick={() => {
                    ...
                    <Box sx={{ pt: '12px', pb: "12px", pl: "8px", pr: "8px", width: "100%", height: "100%", boxSizing: "border-box" }}>
                        <Box sx={{ display: 'flex', justifyContent: "space-between" }}>
                            <Box sx={{ lineHeight: "24px", fontSize: "16px", fontWeight: "400", fontStyle: "normal", color: "rgba(0,0,0,0.9)" }}>User Name 1</Box>
                ...
                <Box onClick={() => {
                    console.log("first")
                    setConnectedUser("user 3")
                    
                }} sx={{ height: "92px", width: "100%", pl: "12px", boxSizing: "border-box", display: "flex", alignItems: "center", '&:hover': { cursor: 'pointer' } }}>
                    <Avatar sx={{ width: "56px", height: "56px" }} />
                    <Box sx={{ pt: '12px', pb: "12px", pl: "8px", pr: "8px", width: "100%", height: "100%", boxSizing: "border-box" }}>
                        <Box sx={{ display: 'flex', justifyContent: "space-between" }}>
                            <Box sx={{ lineHeight: "24px", fontSize: "16px", fontWeight: "400", fontStyle: "normal", color: "rgba(0,0,0,0.9)" }}>User Name 3</Box>
                            <Box sx={{ fontSize: "15px" }}>Date</Box>
                        </Box>
                        <Box sx={{ lineHeight: "20px", fontSize: "14px", fontWeight: "400", fontStyle: "normal", color: "rgba(0,0,0,0.6)" }}>
                            Last Message...
